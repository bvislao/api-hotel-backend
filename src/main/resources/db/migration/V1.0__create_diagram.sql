...
INSERT  INTO `freedb_hotel-utp`.`status` (`id`, `uuid`, `description`, `status`, `created_by`, `created_at`)
...
INSERT  INTO `freedb_hotel-utp`.`room_type` (`id`, `uuid`, `description`, `status`, `created_by`, `created_at`)
...
INSERT  INTO `freedb_hotel-utp`.`rol` (`id`, `uuid`,`code`, `description`, `status`, `created_by`, `created_at`)
...
INSERT  INTO `freedb_hotel-utp`.`users` (`id`, `uuid`, `document_number`, `full_name`, `phone`, `email`, `password`, `status_id`, `status`, `created_by`, `created_at`)
...
INSERT  INTO `freedb_hotel-utp`.`users_role` (`id`, `uuid`, `user_id`, `rol_id`, `status`, `created_by`, `created_at`)
VALUES (1, 'b0f2a3d4-5c8e-4b7c-9f6d-5a2e0f3b8c1e', 1, 1, 1, 'admin', CURRENT_TIMESTAMP);


INSERT  INTO `freedb_hotel-utp`.`hotel` (`id`, `uuid`, `category`, `address`, `location`, `status_id`, `status`, `created_by`, `created_at`)
...
INSERT  INTO `freedb_hotel-utp`.`hotel_room` (`id`, `uuid`, `hotel_id`, `room_type_id`, `room_number`, `price_per_hour`, `price_per_night`, `is_reserved`, `status_id`, `status`, `created_by`, `created_at`)
